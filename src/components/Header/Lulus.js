...
const HeaderLulus = ()=>{
    return (
        <Flex alignItems='center' justifyContent={'space-between'} p={6} bgGradient={'linear(to-r, #0e6308, #32bd00)'} w={'full'} h={'auto'} >
            ...
            <Image src={'/img/main-logo.png'} h={['40px','86px',null]} ml={10} mr={5} alt={'Icon'} />
        </Flex>
    )
}
