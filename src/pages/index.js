      ...
      <Head>
      ...
      </Head>
        {
          ...
          <Box p={6} bgColor='rgba(0,0,0,0.3)' w={'full'} maxW={['full',700,700]} backdropBlur={"md"}>
              ...
              <Text color={'#999'} fontFamily={'Lato'} mb={'30px'}>Masukkan Nomor Peserta</Text>
              <form onSubmit={handleSubmit}>
                  <FormControl>
                      <FormLabel fontFamily={'Lato'} fontWeight={'900'} mb={2} fontSize={'0.9rem'} color={'#88ccf0'}>Nomor Peserta</FormLabel>
                      <Input name={'nopeserta'} color={'white'} focusBorderColor={'#999'} size='lg' border={'none'} borderRadius={'5px'} bg={'rgba(250,250,250,0.2)'} fontSize={['0.8rem','1rem','1.2rem']} fontWeight={'700'} type='number' py={'18px'} px={'18px'} placeholder={'Masukan nomor peserta disini'} />
                      <FormHelperText mb={8}>Terdiri atas 8 digit numerik</FormHelperText>
                      <Button
                          mt={6}
                          isLoading={isLoading}
                          loadingText='Loading'
